...
p <- layout(p,
            ...
            xaxis = list(title = "Maternal Education Level", tickfont = list(size = 7), titlefont = list(size = 12)),
            yaxis = list(
...
- **Sample size**: 42,920 teens from the U.S. and other territories have completed household interviews. Of the 41,194 age-eligible teens (excluding territories) who completed household interviews, 16,568 had provider-verified vaccination histories, which is key to note since 1) the survey weight is based on provider-verified data and 2) the uptake variable P_UTDHPV flags if the provider verified at least one HPV shot before an interview.
- **Data collection**: The data was collected via household interviews with provider-verified vaccination histories.
